...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      frameSrc: ["'self'", "https://accounts.google.com", "https://demo.docusign.net", "https://na4.docusign.net", "https://account-d.docusign.com", "https://account.docusign.com", "https://*.docusign.net", "https://*.docusign.com"],
      objectSrc: ["'none'"],
      baseUri: ["'self'"],
      formAction: ["'self'"],
      frameAncestors: ["'none'"],
